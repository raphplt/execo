...
export default function ModalSexe() {
  const [modal, setModal] = useState(false);
  const [newSexe, setSexe] = useState("");
      ...
      {modal && (
        <div className={styles.modal}>
          ...
          <div className={styles.modalcontent}>
            ...
            <p className={styles.newPassword}>Nouveau Sexe</p>
            <input
              ref={textBoxRef}
              type="text"
              placeholder="Nouveau Sexe"
