...
export default function ProductCard(props: any) {
  ...
  const renderTechnicalData = () => {
    if (props.data.technical_data) {
					const technicalDataEntries = Object.entries(props.data.technical_data);

					return technicalDataEntries.slice(0, 5).map(([key, value]: any, index) => (
  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col justify-center items-center gap-5 w-fit mt-2">
